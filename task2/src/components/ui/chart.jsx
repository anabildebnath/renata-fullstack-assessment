...
function useChart() {
  ...
  if (!context || !context.config) {
    console.warn("useChart must be used within a <ChartContainer /> with a valid config.");
    return { config: {} }; // Return an empty config as a fallback
  }
...
function getPayloadConfigFromPayload(config, payload, key) {
  if (!config || typeof payload !== "object" || payload === null) {
    console.warn("Invalid config or payload provided to getPayloadConfigFromPayload:", { config, payload });
    return undefined;
  }
